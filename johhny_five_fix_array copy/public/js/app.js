$(function(){
	...
	var road_container;
	var robot, robot_xPos = Math.round(viewport().width*.25), robot_yPos = 425;
	var edge_indicator;
	var maxDiv = 35;
	var background;
	var yPos_arr = [];
...
/* ------------------------ CANVAS ------------------------ */
	...
	function checkRobotPosition(){
		...
		edge_indicator.graphics.beginFill('#0000FF').drawCircle(robot_xPos+25, yPos_arr[trans_frame], 5);
		...
		if(robot_yPos < e + 15 || robot_yPos > e + road_width - 50){
